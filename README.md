...
1. What is the **price distribution** across different AC capacities?  
2. How does **price vary** by **star rating**?  
3. What are the **correlations** among key numerical variables?  
4. How does **annual power consumption** vary across **room sizes**?  
5. What is the overall **distribution of power usage** among ACs?
...
## 📈 Future Enhancements
- Automate daily/weekly scraping using **APScheduler or Airflow**.  
- Integrate customer reviews and sentiment analysis.  
- Build a **dashboard (Power BI / Tableau / Streamlit)** for live visualization.
